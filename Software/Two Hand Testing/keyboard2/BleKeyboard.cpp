...
#define GEST_SERVICE_UUID        "fd7241d9-bd53-4b38-8b33-83921fc42837"
#define GEST_CHARACTERISTIC_UUID "aeb6cc01-48f4-483d-bf1e-f82f05be2ce4"
...
void BleKeyboard::begin(void)
{
  ...
  BLEService *gestService = pServer->createService(GEST_SERVICE_UUID);

  gestCharacteristic = gestService->createCharacteristic(
                      GEST_CHARACTERISTIC_UUID,
  ...
  advertising->addServiceUUID(GEST_SERVICE_UUID);
