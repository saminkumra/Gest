...
//BLE server name
#define bleServerName "Gest BLE-Server-1"
...
#define SERVICE_UUID "d1ca45e2-3fea-4d55-9385-85919a7aecda"

BLECharacteristic gestButtonCharacteristic("f78ebbff-c8b7-4107-93de-889a6a06d408", BLECharacteristic::PROPERTY_NOTIFY);
BLEDescriptor bmeTemperatureFahrenheitDescriptor(BLEUUID((uint16_t)0x2902));

// Humidity Characteristic and Descriptor
BLECharacteristic gestTimeCharacteristic("ca73b3ba-39f6-4ab3-91ae-186dc9577d99", BLECharacteristic::PROPERTY_NOTIFY);
