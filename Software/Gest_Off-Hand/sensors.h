...
int FLEX[FLEX_QTY] = {FLEX0_PIN, FLEX1_PIN, FLEX2_PIN, FLEX3_PIN, FLEX4_PIN};
int flexMax[FLEX_QTY] = {0};
int flexMin[FLEX_QTY] = {2500, 2500, 2500, 2500, 2500};
int flexVal[FLEX_QTY];
...
struct flex_t{
  ...
  int measureFlex(int adcLow, int adcHigh){
  ...
  void init(int input, int adcLow, int adcHigh){
    pin = input;
...
flex_t flexArr[FLEX_QTY] = {flex0, flex1, flex2, flex3, flex4};
